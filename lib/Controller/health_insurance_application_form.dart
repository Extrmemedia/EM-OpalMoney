...
import '../ApiService/LifeInsuranceApplicationFormApiService.dart';
...
class HealthInsuranceApplicationForm extends StatefulWidget {
  final String catId;
  final String subcatId;
  final String planId;
   HealthInsuranceApplicationForm({Key key,this.catId,this.planId,this.subcatId}) : super(key: key);

  @override
  State<HealthInsuranceApplicationForm> createState() =>
      _HealthInsuranceApplicationFormState();
}

class _HealthInsuranceApplicationFormState
    extends State<HealthInsuranceApplicationForm> {
  ...
  var childDobTextController = TextEditingController();
