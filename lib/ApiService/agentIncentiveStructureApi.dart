...
class AgentIncentiveStructureApiService{

  static const String url = baseURL+"api/agent-incentive-structure";
  static Future agentIncentiveStructureApiCall(BuildContext context) async {
    try {
